...
const messages = {
  'zh-CN': {
    ...
    upload: {
      ...
      mediaLabel: '点击选择照片或视频',
      mediaHint: '支持图片、视频，可多选',
      mediaHintExplicit: '支持 PNG/JPEG/WEBP/HEIC/MP4/MOV 等常见格式，可多选',
      chronicleAttachmentLabel: '点击选择图片或视频',
      chronicleAttachmentHint: '支持图片、视频',
      chronicleAttachmentHintExplicit: '支持 PNG/JPEG/WEBP/HEIC/MP4/MOV 等常见格式',
      avatarLabel: '点击选择头像图片',
      avatarHint: '支持 PNG、JPEG、WebP，最大 5 MB',
      invalidMediaType: '文件 {name} 不是支持的媒体格式',
      invalidAvatarType: '头像 {name} 必须是 PNG、JPEG 或 WebP 格式',
      avatarTooLarge: '头像 {name} 超过 5 MB 限制',
      knowledgeDocLabel: '点击选择知识库文档',
      knowledgeDocHint: '支持 PDF、Word、Excel、TXT、Markdown',
      invalidKnowledgeDocType: '文件 {name} 不是支持的知识库文档格式',
      tabs: {
        member: '队员',
        media: '媒体',
        work: '作品',
  ...
  en: {
    ...
    upload: {
      ...
      mediaLabel: 'Tap to select photos or videos',
      mediaHint: 'Images and videos supported, multiple selection allowed',
      mediaHintExplicit: 'Supports common formats like PNG/JPEG/WEBP/HEIC/MP4/MOV, multiple selection allowed',
      chronicleAttachmentLabel: 'Tap to select an image or video',
      chronicleAttachmentHint: 'Images and videos supported',
      chronicleAttachmentHintExplicit: 'Supports common formats like PNG/JPEG/WEBP/HEIC/MP4/MOV',
      avatarLabel: 'Tap to select an avatar image',
      avatarHint: 'PNG, JPEG, WebP supported, max 5 MB',
      invalidMediaType: 'File {name} is not a supported media format',
      invalidAvatarType: 'Avatar {name} must be PNG, JPEG, or WebP',
      avatarTooLarge: 'Avatar {name} exceeds the 5 MB limit',
      knowledgeDocLabel: 'Tap to select a knowledge base document',
      knowledgeDocHint: 'Supports PDF, Word, Excel, TXT, Markdown',
      invalidKnowledgeDocType: 'File {name} is not a supported knowledge base document',
      tabs: {
        member: 'Member',
        media: 'Media',
        work: 'Work',
